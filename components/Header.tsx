        ...
        <div className="flex justify-between h-20">
          <div className="flex items-center gap-3 cursor-pointer" onClick={onReset}>
            <motion.div 
              ...
              whileTap={{ scale: 0.9 }}
              className="w-10 h-10 bg-indigo-600 rounded-xl flex items-center justify-center shadow-lg shadow-indigo-100"
            >
                ...
                <AnimatePresence>
                  {showDropdown && (
                    <motion.div 
                      ...
                      className="absolute right-0 mt-3 w-72 bg-white rounded-3xl shadow-2xl border border-slate-100 py-4 z-20"
                    >
                      ...
                      <div className="p-2">
                        <motion.button
                          ...
                          className="w-full flex items-center gap-3 px-4 py-3 text-slate-600 hover:text-indigo-600 rounded-2xl font-bold transition-all"
                        >
                        ...
                        <motion.button
                          ...
                          className="w-full flex items-center gap-3 px-4 py-3 text-rose-500 rounded-2xl font-bold transition-all"
                        >
